...
export const jsonConfig = {
  ...
  mappings: {
    ...
    '/graphql/gateway': {
      redirect: 'https://jiujuaner.com/graphql/hive/docs/gateway',
      status: 302,
    },
    '/graphql/eslint': {
    ...
    '/fets': {
      redirect: 'https://jiujuaner.com/openapi/fets',
      status: 302,
    },
    '/chat': {
    ...
    '/newsletter': {
      redirect: 'https://newsletter.jiujuaner.com',
    },
    '/twitter': {
